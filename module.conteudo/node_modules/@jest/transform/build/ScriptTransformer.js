...
const VERSION = _require.version; // This data structure is used to avoid recalculating some data every time that
...
class ScriptTransformer {
  ...
  _getCacheKey(fileData, filename, instrument) {
    const {configString} = this._cache;
...
const getScriptCacheKey = (filename, instrument) => {
  const {mtime} = _gracefulFs().default.statSync(filename);
